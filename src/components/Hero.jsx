        ...
        <div className="Hero-container">
          ...
          <div className="hero-article-2">
            <div
              ...
              onClick={() => window.open(topNews[2].url, "_blank")}
            >
            ...
            <div
              className="hero-article-small"
              onClick={() => window.open(topNews[3].url, "_blank")}
            >
            ...
            <div
              className="hero-article-small"
              onClick={() => window.open(topNews[4].url, "_blank")}
            >
            ...
            <div
              className="hero-article-small"
              onClick={() => window.open(topNews[5].url, "_blank")}
            >
